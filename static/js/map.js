...
function initMap() {
    ...
    if (typeof L === 'undefined' || !mapElement) {
        ...
        if (fallback) {
            ...
            fallback.textContent = 'The map is unavailable right now. Use the facility list below to find care.';
        }
        console.warn('Map unavailable: Leaflet or map container is missing.');
        return;
    }
