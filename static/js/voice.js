...
class VoiceNavigationSystem {
    ...
    handleVoiceCommand(command) {
        ...
        // Emergency commands
        if (command.includes('emergency') || command.includes('help') || command.includes('112')) {
            this.handleEmergency();
            return;
        }
    ...
    handleEmergency() {
        const emergencyText = `Emergency information: Call 112 for life-threatening emergencies. Call 102 for crisis support. Call 1906 for poison control. This platform provides information only - always call professionals for real emergencies.`;
